...
public class BoardController {
	...
	public String moveBoardUpdateView(@RequestParam("bid") int bid,
	...
	public String boardInsertMethod(Board board, HttpServletRequest request,	// 커맨드객체=?, HttpServletRequest는 첨부파일때문에
		...
		if (mfile != null) {
			...
			if (fileName != null && fileName.length() > 0) {
				...
				String renameFileName = sdf.format(new java.sql.Date(System.currentTimeMillis()));	//System = 자바가 구동되는 컴퓨터
	...
	public String boardUpdateMethod(Board board,
			@RequestParam("page") int currentPage, Model model, //page값
