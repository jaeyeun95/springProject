...
<tr><th>제 목</th><td><input type="text" name="ntitle" value="${ notice.ntitle }"></td></tr>
<tr><th>작성자</th><td><input type="text" name="nwriter" readonly value="${ notice.nwriter }"></td></tr>
<tr><th>파일선택</th>
<td>
	<%-- 원래 첨부파일이 있는 경우 --%>
	<c:if test="${ !empty notice.file_path }">
...
<tr><th>내용</th>
<td><textarea name="ncontent" rows="5"cols="50">${ notice.ncontent }</textarea></td></tr>
<tr><th colspan="2">
<input type="submit" value="수정하기">&nbsp;
<input type="reset" value="등록취소">&nbsp;
<button onclick="javascript:history.go(-1);">이전 페이지로 이동</button></th></tr>
