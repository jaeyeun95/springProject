...
<hr>
<h1 align="center">${ board.bid }번 게시글 수정 페이지</h1>
...
<tr><th>작성자</th><td>
<input type="text" name="bwriter" readonly value="${ board.bwriter }"></td></tr>
<tr><th>첨부파일</th>
<td>
<!-- 첨부파일이 있는데 삭제하는 경우 -->
...
<!-- 다른 파일로 변경하는 경우 -->
바꿀 파일 선택 : <input type="file" name="upfile">	<!-- 변경한다는의미 -->
</c:if>
<c:if test="${ empty board.original_filename }">
새로 첨부할 파일 선택 : <input type="file" name="upfile">
</c:if>
</td></tr>
<tr><th>내용</th><td><textarea name="bcontent" rows="5"cols="50">${ board.bcontent }</textarea></td></tr>
<tr><th colspan="2">
